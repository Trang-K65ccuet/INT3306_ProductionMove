...
export const productStatisticManufacture = async (req, res) => {
    try {
        const sql1 = "SELECT COUNT(*) as totalquantity , MONTH(productitems.dateOfManufacture) as month, YEAR(productitems.dateOfManufacture) as year FROM productitems WHERE manufactureid = :manu_id GROUP BY month, year";
