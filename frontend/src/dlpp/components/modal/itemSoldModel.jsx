...
const ItemSoldModal = ({ open, onClose, product }) => { 
        ...
        <div className="modalRight">
          ...
          <div className="content">
            ...
            <div className="infoFieldWrapper">
              ...
              <label id="infoField">Ngày mua: {product.dateOfTransaction.split("T")[0]}</label>
              <label id="infoField">Số ngày bảo hành: {product.expiredDay}</label>
              <label id="infoField">Số lô: {product.lot}</label>
              <label id="infoField">Số lượng: {product.quantity}</label>
              <label id="infoField">Tên khách hàng: {product.customerName}</label>
              <label id="infoField">Số điện thoại: {product.customerPhoneNumber}</label>
              <label id="infoField">Địa chỉ: {product.customerAddress}</label>
            </div>
          </div>
        </div>
      </div>
